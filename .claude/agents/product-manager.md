...
1. 需求定义和澄清，编写 / 维护 `docs/superpowers/specs/*.md`
2. 特性优先级排序、版本规划
3. 验收标准制定与验收测试
...
- 库的功能边界以 `docs/superpowers/specs/2026-05-07-univer-xlsx-converter-design.md` 为准
- 任何 IWorkbookData 字段层面的需求变更都必须更新 spec
